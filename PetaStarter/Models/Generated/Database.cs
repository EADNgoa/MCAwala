...
namespace Cavala
{
	...
	[TableName("dbo.CashierShiftChanges")]
	[PrimaryKey("CashierID")]
	[ExplicitColumns]
    public partial class CashierShiftChange  
    {
		[Column] public int CashierID { get; set; }
		[Column] public string UserID { get; set; }
		[Column] public DateTime? Tdate { get; set; }
		[Column] public decimal? CashInHand { get; set; }
	}
	...
	[TableName("dbo.SecurityGuard")]
	[PrimaryKey("SecurityGuardID")]
	[ExplicitColumns]
    public partial class SecurityGuard  
    {
		[Column] public int SecurityGuardID { get; set; }
		[Column] public string AttendanceSystemID { get; set; }
		[Column] public string Name { get; set; }
		[Column] public string Address { get; set; }
		[Column] public string Mobile { get; set; }
		[Column] public DateTime? BirthDate { get; set; }
